...
public:
    ...
    void LookAt(Transform p_target, Vector3 p_worldUp);
    void LookAt(Vector3 p_worldPosition, Vector3 p_worldUp);
    void LookAt(Vector3 p_worldPosition);
    void LookAt(Transform p_target);
